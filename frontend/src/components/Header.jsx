            ...
            <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                <div className="flex items-center justify-between h-[72px]">
                    ...
                    <Link to="/" className="flex items-center gap-3 group">
                        <div className="relative w-12 h-12 flex items-center justify-center rounded-2xl bg-gradient-to-br from-[#16A34A] to-[#22c55e] shadow-lg shadow-[#16A34A]/20">
                            <svg viewBox="0 0 40" className="w-10 h-10" fill="none">
                                <rect x="4" y="8" width="32" height="24" rx="6" fill="#ffffff" opacity="0.08" stroke="#ffffff" strokeWidth="2" />
                                <circle cx="20" cy="20" r="6" stroke="#ffffff" strokeWidth="2" fill="rgba(255,255,255,0.14)" />
                                <path d="M12 24s4 2 8-1 8 1 8 1" stroke="#ffffff" strokeWidth="1.5" />
                                <path d="M12 16s4-2 8 1 8-1 8-1" stroke="#ffffff" strokeWidth="1.5" />
                                <path d="M20 12v16" stroke="#ffffff" strokeWidth="2" />
                            </svg>
                        </div>
